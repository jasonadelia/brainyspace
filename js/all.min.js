...
e;if(a>=b)return g!=(e=f.last()[0])&&this.activate(e);for(e=c.length;e--;)g!=f[e]&&a>=c[e]&&(!c[e+1]||a<=c[e+1])&&this.activate(f[e])},activate:function(a){this.activeTarget=a;b(this.selector).parent(".active").removeClass("active");a=b(this.selector+'[data-target="'+a+'"],'+this.selector+'[href="'+a+'"]').parent("li").addClass("active");a.parent(".dropdown-menu").length&&(a=a.closest("li.dropdown").addClass("active"));a.trigger("activate")}};var j=b.fn.scrollspy;b.fn.scrollspy=function(a){return this.each(function(){var d=
...
var $nav=$("#navbar");var $navPlaceholder=$("<div />",{height:$nav.outerHeight()});$(window).scroll(function(){if(!$nav.hasClass("fix")&&$(window).scrollTop()>$nav.offset().top){$nav.before($navPlaceholder);$nav.addClass("fix")}else{if($nav.hasClass("fix")&&$(window).scrollTop()<$navPlaceholder.offset().top){$nav.removeClass("fix");$navPlaceholder.remove()}}});$("#navbar").on("click","a",function(){var c=$(this);var b=this.hash;var a=$(b).offset().top;stopAnimatedScroll();$("html, body").stop().animate({scrollTop:a},400,function(){window.location.hash=b});return false});function stopAnimatedScroll(){if($("*:animated").length>0){$("*:animated").stop()}};